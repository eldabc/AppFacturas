...
class Item implements \JsonSerializable
{
    ...
    private $stock;
     ...
     /**
     * @var integer $item_id_provider
     *
     * @ORM\Column(name="item_id_provider", type="integer", nullable=true)
     */
    private $item_id_provider;
    ...
    /**
     * Get item_id_provider
     *
     * @return integer
     */
    public function getItemIdProvider()
    {
        return $this->item_id_provider;
    }

    /**
     * Set Item_id_provider
     *
     * @param integer $item_id_provider
     */
    public function setItemIdProvider($item_id_provider)
    {
        $this->item_id_provider = $item_id_provider;
    }
    ...
    //  * @ORM\PreUpdate()
    //  */
    // public function updateStock(LifecycleEventArgs $args)
    // {
    ...
    //         echo "<br>".  $item->getQuantity();
    //         // $item->setStock(2);

    //         // $entity = $repo->findOneBy(array('id' => $item->getId()));
